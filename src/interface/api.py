...
async def api_change_expiration_time(link_id: str = Depends(get_link_id), new_expiration_time: Union[str, None] = Depends(get_expiration_time), interface: LinkInterface = Depends(get_link_interface)):
...
async def api_delete_expiration_time(link_id: str = Depends(get_link_id), interface: LinkInterface = Depends(get_link_interface)):
